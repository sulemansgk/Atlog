		...
		<section>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						<input type="text" readonly="readonly" class="form-control"  value="<?=$log["call_time"]?>" />
					</span>
				</div>
				<div class="col-md-6">
					<span class="form-field-title">First Date Of Sickness</span>
					<span class="form-field">
						<input type="text" readonly="readonly" class="form-control"  value="<?=$log["date_of_sickness"]?>" />
					</span>
				</div>
				<?
			...
			<div class="row">
				<fieldset>
					...
					<div class="col-md-6">
						<span class="form-field-title">Name</span>
						<span class="form-field">
							<input type="text" value="<?=$name2?>" class="form-control" readonly="readonly" />
						</span>
					</div>
					<div class="col-md-6">
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						<input type="text" class="form-control" value="<?=$log["absence_reason_details"]?>" readonly="readonly" />
					</span>
				</div>
				<div class="col-md-6">
					<?
				...
				<div class="form-actions left">
					...
					<div class="col-md-5">
						<div class=" form-actions" style="margin-top:5%">
							<input type="button" onclick="updatesicknessforduty(<?=$log["id"]?>);" class="btn btn-success" value="Submit" />
						</div>
					</div>
					<?php } ?>
				</div>
