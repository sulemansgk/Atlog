	...
	<div id="page-content" class="page-content">
		<section>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<span class="form-field-title">First Day Of Unavailability</span>
					<span class="form-field">
						<input type="text" class="form-control" readonly="readonly"  value="<?=$log["day_of_unavailibility"]?>" />
					</span>
				</div>
				<?
				...
				<div class="form-actions left">
					...
					<div class="col-md-5">
						<div class=" form-actions" style="margin-top:5%">
							<input type="button" onclick="updateunavailableforduty(<?=$log["id"]?>);" class="btn btn-success" value="Submit" />
						</div>
					</div>
					<?php } ?>
				</div>
