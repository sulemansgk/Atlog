		...
		<section>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						<input type="text" class="form-control" name="type_of_incident"  readonly="readonly" value="<?=$log["type_of_incident"]?>" />
					</span>
				</div>
				<div class="col-md-6">
			...
			<div class="col-md-6">
				...
				<span class="form-field"><input type="text" name="location" value="<?=$log["location"]?>" readonly="readonly" class="form-control auto2 ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
			</span>
		</div>
		<div class="col-md-6">
			<span class="form-field-title">Aircraft Type:</span>
			<span class="form-field"><input type="text" name="aircraft_type" value="<?=$log["aircraft_type"]?>" readonly="readonly" class=" form-control auto3 ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
		</span>
	</div>
	<div class="col-md-6">
		<span class="form-field-title">Persons on Board:</span>
		<span class="form-field"><input name="persons_on_board" class="form-control" value="<?=$log["persons_on_board"]?>" readonly="readonly" type="text" id="textfield" maxlength="4">
	</span>
</div>
<div class="col-md-6">
...
<div class="col-md-6">
	...
	<span class="form-field"><input type="text" name="aircraft_operator" value="<?=$log["aircraft_operator"]?>" readonly="readonly" class="form-control auto4 ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>                          </span>
</div>
<div class="col-md-6">
	<span class="form-field-title">Callsign:</span>
	<span class="form-field"><input type="text" name="callsign" value="<?=$log["callsign"]?>" readonly="readonly" class="form-control auto5 ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
</span>
</div>
<div class="col-md-6">
<span class="form-field-title">Dangerous Goods:</span>
<span class="form-field"><input type="text" name="dangerous_goods" value="<?=$log["dangerous_goods"]?>" readonly="readonly" class="form-control auto6 ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
</span>
</div>
<div class="col-md-6">
<span class="form-field-title">Point of Departure:</span>
<span class="form-field"><input type="text" name="point_of_departure" value="<?=$log["point_of_departure"]?>" readonly="readonly" class="form-control auto7 ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
</span>
</div>
<div class="col-md-6">
<span class="form-field-title">Destination:</span>
<span class="form-field"><input type="text" name="destination" value="<?=$log["destination"]?>" readonly="readonly" class="form-control auto8 ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
</span>
</div>
<div class="col-md-6">
<span class="form-field-title"> Nature of Accident:</span>
<span class="form-field">
<input type="text" name="nature_of_accident" value="<?=$log["nature_of_accident"]?>" readonly="readonly" class="form-control auto9 ui-autocomplete-input" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
</span>
</div>
<div class="col-md-6">
<span class="form-field-title"> Time of Accident (UTC):</span>
<span class="form-field">
<input type="text" name="time_of_accident" value="<?=$log["time_of_accident"]?>" readonly="readonly" class="datetime-field form-control" />
</span>
</div>
