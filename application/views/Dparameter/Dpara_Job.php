...
<span class="edit-delete">
	...
	if($this->userdetails["agentcode"] == 3){
	?>
	<a href="javascript:void(0);"  class="btn btn-blue" onclick="editdparajob(<?=$instruction["id"]?>,this,'Edit: <?=$instruction["name"]?>','<?=str_replace(" ","",$view)?>');">Edit</a>
	<a href="javascript:void(0);" class="btn btn-red"  onclick="deletedparajob(<?=$instruction["id"]?>,this);">Delete</a>
