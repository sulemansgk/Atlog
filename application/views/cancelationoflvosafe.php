<div id="page-content" class="page-content">
	<section>
		...
		<form class="emergency-edit-form" method="post" action="<?=base_url()?>elog/cancelsafeLVO">
			
			
			<div class="row">
				<div class="col-md-6">
					<span class="form-field-title">Safe Lvo Id</span>
					<span class="form-field">
						<input type="text" name="safe_lvo_id" class="form-control"  readonly="readonly"  value="<?=$PostId?>" />
					</span>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						<input type="text" class="form-control" name="subject"   value="Cancel Lvo SafeGuard"  readonly="readonly"/>
					</span>
				</div>
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						<input type="checkbox" name="checked2" value="1" style="
						float: left;
						">
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						<input type="checkbox"  name="checked" value="1" style="
						float: left;
						">
				...
				<div class="form-actions left">
					...
					<div class="col-md-5">
						<div class=" form-actions" style="margin-top:5%">
							...
							<input type="submit" class="btn btn-primary" value="ok" onclick="cancelsafeLVO(<?=$log["id"]?>);" />
						</div>
					</div>
				</div>
			</div>
