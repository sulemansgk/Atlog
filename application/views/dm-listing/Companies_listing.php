<div class="row">
	...
	<br>
	<a style='margin-left: 87%;' class='btn btn-primary' href="<?=base_url()?>domainparameters/Company">Add Company</a>
	<br>
	<br>
	<div class="col-md-12" >
		...
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Companies
				</div>
				<div class="tools">
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr >
								...
								<td>
									<a href="javascript:void(0);"  class="btn btn-primary" onclick="editCompany(<?=$row["id"]?>,'Edit: <?=$row["subject"]?>');">Edit</a><a href="javascript:void(0);" class="btn btn-danger"  onclick="deleteCompany(<?=$row["id"]?>,this);">Delete</a>
								</td>
