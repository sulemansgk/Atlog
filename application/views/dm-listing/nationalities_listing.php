<div class="row">
	...
	<br>
	<a style='margin-left: 87%;' class='btn btn-primary' href="<?=base_url()?>domainparameters/Nationality">Add Nationality</a>
	<br>
	<br>
	<div class="col-md-12" >
		...
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Nationalities
				</div>
				<div class="tools">
			...
			<div class="portlet-body">
				...
				<div class="table-scrollable">
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?
							foreach($nationalities as $key=>$row){
							...
							<tr >
								...
								<td>
									<a href="javascript:void(0);"  class="btn btn-primary" onclick="editNationality(<?=$row["id"]?>,'Edit: <?=$row["nationality"]?>');">Edit</a><a href="javascript:void(0);" class="btn btn-danger"  onclick="deleteNationality(<?=$row["id"]?>,this);">Delete</a>
								</td>
