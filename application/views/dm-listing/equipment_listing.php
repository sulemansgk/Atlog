	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Equipments Search
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<form action="<?=base_url()?>domainparameters/viewEquipmentNames" method="post" class="accesslogs-search-form">
	...
	<div class="col-md-12" >
		...
		<div class="portlet box purple">
			<div class="portlet-title">
				...
				<a style='margin-left: 70%;margin-top: 4px;' class='btn btn-primary' href="<?=base_url()?>domainparameters/EquipmentName">Add Equipment</a>
				<div class="tools">
					<a href="javascript:;" class="collapse" data-original-title="" title="">
					</a>
					<a href="#portlet-config" >
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr >
								...
								<td>
									<a href="javascript:void(0);"  class="btn btn-primary" onclick="editEquipment(<?=$row["id"]?>,'Edit: <?=$row["subject"]?>');">Edit</a><a href="javascript:void(0);" class="btn btn-danger"  onclick="deleteEquipment(<?=$row["id"]?>,this);">Delete</a>
								</td>
