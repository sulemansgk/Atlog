	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Runway Manoeuvring Areas Search
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<form action="<?=base_url()?>domainparameters/viewRunwayManoeuvringAreas" method="post" class="accesslogs-search-form">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<select name="agentunit" class="form-control">
									...
									?>
									<option <?php if($rma_filter["agentunit"] == $unit["unit_id"]){?> selected="selected"<?}?> value="<?=$unit_name->unit_id?>"><?=$unit_name->unit?></option>
									<?php
										}
									?>
								</select>
...
<div class="row">
	<div class="col-md-12" >
		...
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Runway Manoeuvring Areas
				</div>
				<a style='margin-left: 47%;margin-top: 4px;' class='btn btn-primary' href="<?=base_url()?>domainparameters/RunwayManoeuvringArea">Add Runway/Manoeuvring Area</a>
				<div class="tools">
					<a href="javascript:;" class="collapse" data-original-title="" title="">
					</a>
					<a href="#portlet-config" >
			...
			<div class="portlet-body">
				...
				<div class="table-scrollable">
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?
							foreach($RunwayManoeuvringAreas as $key=>$row){
							...
							<tr >
								...
								<td>
									<a href="javascript:void(0);"  class="btn btn-primary" onclick="editRunwayManoeuvringArea(<?=$row["id"]?>,'Edit: <?=$row["subject"]?>');">Edit</a><a href="javascript:void(0);" class="btn btn-danger"  onclick="deleteRunwayManoeuvringArea(<?=$row["id"]?>,this);">Delete</a>
								</td>
