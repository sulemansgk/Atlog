	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Console Numbers Search
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<form action="<?=base_url()?>domainparameters/viewConsoleNumbers" method="post" class="accesslogs-search-form">
...
<div class="row">
	<div class="col-md-12" >
		...
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Console Numbers
				</div>
				<a style='margin-left: 62%;margin-top: 4px;' class='btn btn-primary' href="<?=base_url()?>domainparameters/ConsoleNumber">Add Console Number</a>
				<div class="tools">
					<a href="javascript:;" class="collapse" data-original-title="" title="">
					</a>
					<a href="#portlet-config" >
			...
			<div class="portlet-body">
				...
				<div class="table-scrollable">
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?
							foreach($consolenumbers as $key=>$row){
							...
							<tr >
								...
								<td>
									<a href="javascript:void(0);"  class="btn btn-primary" onclick="editConsoleNumber(<?=$row["id"]?>,'Edit: <?=$row["subject"]?>');">Edit</a><a href="javascript:void(0);" class="btn btn-danger"  onclick="deleteConsoleNumber(<?=$row["id"]?>,this);">Delete</a>
								</td>
