<div class="row">
	...
	<br>
	<a style='margin-left: 83%;' class='btn btn-primary' href="<?=base_url()?>domainparameters/instructionType">Add instruction Type</a>
	<br>
	<br>
	<div class="col-md-12" >
		...
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Instruction Types
				</div>
				<div class="tools">
			...
			<div class="portlet-body">
				...
				<div class="table-scrollable">
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?
							foreach($InstructionTypes as $key=>$row){
							...
							<tr >
								...
								<td>
									<a href="javascript:void(0);"  class="btn btn-primary" onclick="editInstructionType(<?=$row["id"]?>,'Edit: <?=$row["name"]?>');">Edit</a><a href="javascript:void(0);" class="btn btn-danger"  onclick="deleteInstructionType(<?=$row["id"]?>,this);">Delete</a>
								</td>
