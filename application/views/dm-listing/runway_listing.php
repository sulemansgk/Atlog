	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Runways Search
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<form action="<?=base_url()?>domainparameters/viewRunways" method="post" class="accesslogs-search-form">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<select name="agentunit" class="form-control">
									...
									?>
									<option <?if($runway_filter["agentunit"] == $unit["unit_id"]){?>selected="selected"<?}?> value="<?=$unit_name->unit_id?>"><?=$unit_name->unit?></option>
									<?
									}
									?>
								</select>
...
<div class="row">
	<div class="col-md-12" >
		...
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Runways
				</div>
				<a style='margin-left: 75%;margin-top: 4px;' class='btn btn-primary' href="<?=base_url()?>domainparameters/runway">Add Runway</a>
				<div class="tools">
					<a href="javascript:;" class="collapse" data-original-title="" title="">
					</a>
					<a href="#portlet-config" >
			...
			<div class="portlet-body">
				...
				<div class="table-scrollable">
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							<?
							foreach($runways as $key=>$row){
							$query = $this->db->query('SELECT * FROM units WHERE unit_id ='.$row["unit_id"]);
							$row1 = $query->row();
							//echo "<pre>"; print_r($row1->unit);die();
								?>
								...
								<tr > 
									...
									<td>
										<a href="javascript:void(0);"  class="btn btn-primary" onclick="editRunway(<?=$row["runway_id"]?>,'Edit: <?=$row["runway"]?>');">Edit</a><a href="javascript:void(0);" class="btn btn-danger"  onclick="deleteRunway(<?=$row["runway_id"]?>,this);">Delete</a>
									</td>
