	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Emails Search
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<form action="<?=base_url()?>domainparameters/viewEmails" method="post" class="accesslogs-search-form">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<select name="agentunit" class="form-control">
									...
									?>
									<option <?if($emails_filter["agentunit"] == $unit["unit_id"]){?>selected="selected"<?}?> value="<?=$unit_name->unit_id?>"><?=$unit_name->unit?></option>
									<?
									}
									?>
								</select>				</div>
	...
	<div class="row">
		<div class="col-md-12" >
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-desktop"></i>Emails
					</div>
					<a style='margin-left: 78%;margin-top: 4px;' class='btn btn-primary' href="<?=base_url()?>domainparameters/email">Add Email</a>
					<div class="tools">
						<a href="javascript:;" class="collapse" data-original-title="" title="">
						</a>
						<a href="#portlet-config" >
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr >
									...
									<td>
										<a href="javascript:void(0);"  class="btn btn-primary" onclick="editEmail(<?=$row["email_id"]?>,'Edit: <?=$row["email_address"]?>');">Edit</a><a href="javascript:void(0);" class="btn btn-danger"  onclick="deleteEmail(<?=$row["email_id"]?>,this);">Delete</a>
									</td>
