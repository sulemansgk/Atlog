<div class="row">
	...
	<br>
	<a style='margin-left: 91%;' class='btn btn-primary' href="<?=base_url()?>domainparameters/latestLRU">Add LRU</a>
	<br>
	<br>
	<div class="col-md-12" >
		...
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>latestLRU
				</div>
				<div class="tools">
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr >
								...
								<td>
									<a href="javascript:void(0);"  class="btn btn-primary" onclick="editLRU(<?=$row["id"]?>,'Edit: <?=$row["name"]?>');">Edit</a><a href="javascript:void(0);" class="btn btn-danger"  onclick="deleteLRU(<?=$row["id"]?>,this);">Delete</a>
								</td>
