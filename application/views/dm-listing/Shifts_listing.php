<div class="row">
	...
	<br>
	<a style='margin-left: 90%;' class='btn btn-primary' href="<?=base_url()?>domainparameters/Shift">Add Shift</a>
	<br>
	<br>
	<div class="col-md-12" >
		...
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Shifts
				</div>
				<div class="tools">
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr >
								...
								<td>
									<a href="javascript:void(0);"  class="btn btn-primary" onclick="editShift(<?=$row["id"]?>,'Edit: <?=$row["subject"]?>');">Edit</a><a href="javascript:void(0);" class="btn btn-danger"  onclick="deleteShift(<?=$row["id"]?>,this);">Delete</a>
								</td>
