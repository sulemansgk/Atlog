	...
	<div id="page-content" class="page-content">
		<section>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<span class="form-field-title"> Time of Call from OMAD:</span>
					<span class="form-field">
						<input type="text" name="time_of_accident" value="<?=$log["time_of_accident"]?>" readonly="readonly" class="omad-datetime-field form-control"  />
					</span>
				</div>
				<div class="col-md-6">
		...
		<div class="col-md-6">
			...
			<span class="form-field"><input name="persons_on_board" value="<?=$log["persons_on_board"]?>" class="form-control" readonly="readonly" type="text" id="textfield" maxlength="4">
		</span>
	</div>
	<div class="col-md-6">
