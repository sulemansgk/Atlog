			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						...
						<input type="text" name="onbehalf" class="form-control" value="<?=$log["Update_ATIS"]?>" readonly="readonly" required="required" />
					</span>
				</div>
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						...
						<input type="text" name="onbehalf" class="form-control" value="<?=$log["onbehalf"]?>" readonly="readonly" required="required" />
					</span>
				</div>
				...
				<div class="form-actions left">
					...
					<div class="col-md-5">
						<div class=" form-actions" style="margin-top:5%">
							...
							<input type="button" class="btn btn-primary" value="Cancel LVO Safe" onclick="cancelationoflvosafe(<?=$log["id"]?>);" />
						</div>
					</div>
				</div>
			</div>
