<div class="row-fluid page-head">
	...
	<h2 class="page-title"><i class="aweso-icon-list-alt"></i> Domain Parameter Job</h2>
	<div class="page-bar">
		<div class="btn-toolbar"> </div>
	</div>
</div>
<div class="viewlist-link">
	<a href="<?=base_url()?>instructions/ViewparaJob" class="btn btn-blue">View Domain Parameter Job</a>
</div>
<!-- // page head -->
