	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Supervisor Report
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				...
				<form action="<?=base_url()?>report/generateSupervisorReport" class="log-add-form" method="post">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<select name="subject"  class="form-control" required="required">
									...
									if(trim($data_subject["supervisor_report"]) == "on"){
									?>
...
<div class="row" id="printableArea">
	<div id="printheader" style="display: none">
		...
		<div class="row" style="margin-right: 0;margin-left: 0;margin-bottom: 10px">
			<div class="col-md-12" style="margin-top: 3%;text-align: center;">
				<h2 style="margin-top: 0;"><b>Supervisor Report</b></h2>
			</div>
		</div>
		<div class="row" style="margin-right: 0;margin-left: 0;margin-bottom: 10px">
	...
	<div class="col-md-12 mt" >
		...
		<div class="portlet box purple remBox">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop remIcon"></i>Supervisor Report
				...
				<div class="table-scrollable">
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							//echo "<pre>";print_r($supervisor_reports);die();
								foreach($supervisor_reports as $key=>$supervisor_report){
								$date = date('d/m/Y',strtotime($supervisor_report["ge_datetime"]));
								$time = date("H:m:s",strtotime($supervisor_report["ge_datetime"]));
								
								?>
								
								<tr > 
									<td>
										<?=$supervisor_report["initial_details"]["agentname"]?>
									</td>
									<td>
										<?=$date?> <?=$time?>
									</td>
									<td>
										<?=$supervisor_report["subject_subject"]?>
										
									</td>
									<td>
										<?
										if(!empty($supervisor_report["initial_details"]["firstname"])){
										echo "Firstname :" . $supervisor_report["initial_details"]["firstname"].'<br>';
										}
										if(!empty($supervisor_report["initial_details"]["lastname"])){
										echo "Lastname :" . $supervisor_report["initial_details"]["lastname"].'<br>';
										}
										if(!empty($supervisor_report["initial_details"]["email"])){
										echo "Email :" . $supervisor_report["initial_details"]["email"].'<br>';
										}
										?>
									...
									<td>
										<?
										if(!empty($supervisor_report["ge_management"])){
										echo $supervisor_report["ge_management"];
										}else{
										echo "-";
										}
									...
									<td>
										<?
										if(!empty($supervisor_report["ge_actions"])){
										echo $supervisor_report["ge_actions"];
										}else{
										echo "-";
										}
									...
									<td class="action">
										<button class="btn btn-danger btn-delete-row" onclick="deleteDailyReportRow(this,<?=$supervisor_report["ge_id"]?>,'supervisor');">Del</button>
									</td>
								...
								?>
								<tr>
									<td colspan="7">Supervisor report not available!</td></tr>
									<?
									}
									?>
