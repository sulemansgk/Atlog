	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>General Report
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				...
				<form action="<?=base_url()?>report/generateGeneralReport" class="log-add-form" method="post">
					...
					<div class="row pform" style="padding-bottom:2%; ">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<select name="subject[]"  class="form-control" multiple="multiple" >
	...
	<div id="printheader" style="display: none">
		...
		<div class="row" style="margin-right: 0;margin-left: 0;margin-bottom: 10px">
			<div class="col-md-12" style="margin-top: 3%;text-align: center;">
				<h2 style="margin-top: 0;"><b>General Report</b></h2>
			</div>
		</div>
		<div class="row" style="margin-right: 0;margin-left: 0;margin-bottom: 10px">
					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr >
								...
								<td>
									<?
									if(!empty($log["details"]["Management"])){
									echo $log["details"]["Management"];
									}else{
									echo "-";
									}
								...
								<td>
									<?
									if(!empty($log["details"]["actions"])){
									echo $log["details"]["actions"];
									}else{
									echo "-";
									}
							...
							?>
							<tr>
								<td colspan="7">General report not available!</td>
							</tr>
							<?
							}
							?>
