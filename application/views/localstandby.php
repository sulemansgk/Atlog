	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Local Standby
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<form action="<?=base_url()?>emergency/insertlog" class="log-add-form" method="post">
					<input type="hidden" name="type_of_incident" value="Local Standby" />
					...
					<div class="row pform" >
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<!-- <input type="text" name="eta" value="<?=date("H:i:s")?>" class="etimefield timepicker-default form-control" placeholder="Enter value..." oninput="maxLengthCheck(this);"/> -->
								<input type="text" placeholder="Time" class="etimefield timefield form-control clockpicker" value="<?=date("H:i", strtotime('-4 hours'))?>" name="eta" oninput="maxLengthCheck(this);" />
							</div>
						</div>
					...
					<div class="row pform" style="padding-bottom:2%; ">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<!-- <input type="text" name="time_of_accident" value="<?=date("H:i:s")?>" class="timepicker-default timefield form-control" placeholder="Enter value..." oninput="maxLengthCheck(this);"/> -->
