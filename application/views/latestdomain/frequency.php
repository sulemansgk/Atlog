	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Domain Parameter Frequency
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				...
				<form action="<?=base_url()?>elog/insertfrequency" class="log-add-form" method="post">
					...
					<div class="form-actions left">
						...
						<div class="col-md-6">
							...
							<div class=" form-actions" style="border-top: 0">
								...
								<a href="<?=base_url()?>domainparameters/Viewparafrequency" class="btn btn-primary">View Domain Parameter Frequency</a>
