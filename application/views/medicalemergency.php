	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Medical Emergency
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<form action="<?=base_url()?>emergency/insertlog" class="log-add-form" method="post">
					<input type="hidden" name="type_of_incident" value="Medical Emergency" />
					...
					<div class="row pform" style="padding-top:1%;"  >
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="hidden" name="nature_of_accident" class="form-control" value="INCIDENT INFORMATION2">
							</div>
						</div>
					...
					<div class="row pform" >
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<!-- <input type="text" name="eta" value="<?=date("H:i:")?>" class="etimefield form-control timepicker-default" placeholder="Enter value..." oninput="maxLengthCheck(this);"/> -->
