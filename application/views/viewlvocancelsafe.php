		...
		<form class="emergency-edit-form" method="post" action="<?=base_url()?>emergency/updatelog">
			...
			<div class="form-row" style="clear:left;">
				...
				<span class="form-field">
					...
					<input type="text" name="onbehalf" value="<?=$log["Update_ATIS"]?>" readonly="readonly" required="required" />
				</span>
			</div>
			...
			<div class="form-row">
				...
				<span class="form-field">
					...
					<input type="button" class="btn btn-blue" value="Cancel" onclick="cancelationoflvosafe(<?=$log["id"]?>);" />
				</span>
			</div>
		</form>
	</div>
