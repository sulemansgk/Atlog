	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>OMAD Emergencies
				</div>
				<div class="tools">
					...
					<div class="row pform" style="padding-top:1%;"  >
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="number" name="time_of_call_omad" value="<?=date("Hi")?>" class="etimefield form-control" placeholder="Enter value..." oninput="maxLengthCheck(this);"/>
							</div>
						</div>
					...
					<div class="row pform" style="padding-bottom:2%; ">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="number" name="time_of_accident" value="<?=date("Hi")?>" class="timepicker-default timefield form-control" placeholder="Enter value..." oninput="maxLengthCheck(this);"/>
							</div>
						</div>
