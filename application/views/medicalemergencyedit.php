<form action="<?=base_url()?>emergency/insertlog" class="emergency-edit-form" method="post">
		...
		<section>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<input type="text"  readonly="readonly" class="form-control"  value="<?=date("H:i:s",strtotime($log["datetime"]))?>" />
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						INCIDENT INFORMATION2
						<input type="hidden" class="form-control" name="nature_of_accident" value="INCIDENT INFORMATION2">
					</span>
				</div>
				<div class="col-md-6">
	...
	<div class="col-md-6">
		...
		<span class="form-field">
			<input type="text" name="eta" value="<?=$log["eta"]?>" readonly="readonly" class="eta-datetime-field form-control" />
		</span>
	</div>
	<div class="col-md-6">
...
<span class="form-field">
<input type="text" name="time_of_accident" class="form-control" value="<?=$log["time_of_accident"]?>" readonly="readonly" class="datetime-field" />
</span>
</div>
