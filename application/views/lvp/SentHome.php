	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Sent Home
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<form action="<?=base_url()?>elog/insertlvp" class="log-add-form" method="post">
					<input type="hidden" name="subject" value="Sent Home" />
					...
					<div class="row pform" >
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<!-- <input type="text"  oninput="maxLengthCheck(this);" class="timepicker timepicker-default form-control" name="sent_home_time" /> -->

								<input type="text" oninput="maxLengthCheck(this);" name="sent_home_time" placeholder="Time" value="<?=date("H:i")?>" class="form-control clockpicker">
							</div>
						</div>
