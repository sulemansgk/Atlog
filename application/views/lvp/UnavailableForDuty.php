	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Unavailable For Duty
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<form action="<?=base_url()?>elog/insertlvp" class="log-add-form" method="post">
					<input type="hidden" name="subject" value="Unavailable For Duty" />
					...
					<div class="row pform" >
						<div class="col-md-6">
							...
							<div class="form-group">
								<span class="form-field-title">First Day Of Unavailibility</span>
								<input type="text" class="datetime-field form-control date-picker" name="day_of_unavailibility"/>
							</div>
						</div>
