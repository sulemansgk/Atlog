		...
		<form class="emergency-edit-form" method="post" action="<?=base_url()?>emergency/updatelog">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						<input type="text" name="to_from" class="form-control"  readonly="readonly" value="<?=$log["to_from"]?>" readonly="readonly" placeholder="Enter value..." />
					</span>
				</div>
				<div class="col-md-6">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<span class="form-field">
						<input type="text" readonly="readonly" name="control_mobile2" class="btn <?if(trim($log["control_mobile2"]) == "IN"){?> btn-success <?}else{?>btn-danger<?}?>" style="cursor: pointer;" value="<?=$log["control_mobile2"]?>" readonly="readonly" />
