		...
		<section>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						<input type="text" name="location" class="form-control" value="<?=$log["location"]?>" readonly="readonly" placeholder="Enter value..." />
					</span>
				</div>
				<div class="col-md-6">
					<span class="form-field-title">Aircraft Type:</span>
					<span class="form-field">
						<input type="text" name="aircraft_type" class="form-control" value="<?=$log["aircraft_type"]?>" readonly="readonly" placeholder="Enter value..." />
					</span>
				</div>
				<div class="col-md-6">
					<span class="form-field-title">Persons on Board:</span>
					<span class="form-field">
						<input name="persons_on_board" type="text" class="form-control" value="<?=$log["persons_on_board"]?>" readonly="readonly" id="textfield" maxlength="4" placeholder="Enter value..." />
					</span>
				</div>
				<div class="col-md-6">
					<span class="form-field-title">Aircraft Operator:</span>
					<span class="form-field">
						<input type="text" name="aircraft_operator" class="form-control" value="<?=$log["aircraft_operator"]?>" readonly="readonly" placeholder="Enter value..." />
					</span>
				</div>
				<div class="col-md-6">
					<span class="form-field-title">Callsign:</span>
					<span class="form-field">
						<input type="text" name="callsign" class="form-control" value="<?=$log["callsign"]?>" readonly="readonly" placeholder="Enter value..." />
					</span>
				</div>
				<div class="col-md-6">
					<span class="form-field-title">Dangerous Goods:</span>
					<span class="form-field">
						<input type="text" name="dangerous_goods" class="form-control" value="<?=$log["dangerous_goods"]?>" readonly="readonly" placeholder="Enter value..." />
					</span>
				</div>
				<div class="col-md-6">
					<span class="form-field-title">Point of Departure:</span>
					<span class="form-field">
						<input type="text" name="point_of_departure" class="form-control" value="<?=$log["point_of_departure"]?>" readonly="readonly" placeholder="Enter value..." />
					</span>
				</div>
				<div class="col-md-6">
					<span class="form-field-title">Destination:</span>
					<span class="form-field">
						<input type="text" name="destination" class="form-control" value="<?=$log["destination"]?>" readonly="readonly" placeholder="Enter value..." />
					</span>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-6">
					...
					<span class="form-field">
						<input type="text" name="time_of_accident" value="<?=$log["time_of_accident"]?>" readonly="readonly" class="datetime-field form-control" placeholder="Enter value..." />
					</span>
				</div>
