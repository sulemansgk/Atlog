...
<script src="<?=base_url()?>assets/js/lib/jquery.date.min.js"></script>
...
<?if($this->uri->segment(1) == ""){?>
<!-- Only This Demo Page -->
<script src="<?=base_url()?>assets/js/demo/demo-dashboard1.js"></script>
<?}?>
<!-- Datepicker files -->
<link rel="stylesheet" href="<?=base_url()?>assets/datepicker/themes/base/jquery.ui.all.css">
<link rel="stylesheet" href="<?=base_url()?>assets/datepicker/jquery-ui-timepicker-addon.css">
<script src="<?=base_url()?>assets/datepicker/ui/jquery.ui.core.js"></script>
<script src="<?=base_url()?>assets/datepicker/ui/jquery.ui.widget.js"></script>
<script src="<?=base_url()?>assets/datepicker/ui/jquery.ui.datepicker.js"></script>
<script src="<?=base_url()?>assets/datepicker/jquery-ui-timepicker-addon.js"></script>
<script src="<?=base_url()?>assets/datepicker/ui/jquery.ui.core.js"></script>
<script src="<?=base_url()?>assets/datepicker/ui/jquery.ui.widget.js"></script>
<script src="<?=base_url()?>assets/datepicker/ui/jquery.ui.mouse.js"></script>
<script src="<?=base_url()?>assets/datepicker/ui/jquery.ui.slider.js"></script>
<!-- Datepicker files -->
<!-- Jquery Form Validation Files -->
<link rel="stylesheet" href="<?=base_url()?>assets/jquery_validate/css/screen.css" />
<script src="<?=base_url()?>assets/jquery_validate/dist/jquery.validate.js"></script>
<!-- Jquery Form Validation Files -->
<!-- Jquery Messi Dialog Files -->
<link rel="stylesheet" href="<?=base_url()?>assets/plugins/messi/messi.css" />
<script src="<?=base_url()?>assets/plugins/messi/messi.js"></script>
<!-- Jquery Messi Dialog Files -->
<!-- Jquery ui multiselect -->
<link type="text/css" href="<?=base_url()?>assets/plugins/michael-multiselect-d918211/css/ui.multiselect.css" rel="stylesheet" />
<script type="text/javascript" src="<?=base_url()?>assets/plugins/michael-multiselect-d918211/js/plugins/localisation/jquery.localisation-min.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/plugins/michael-multiselect-d918211/js/plugins/scrollTo/jquery.scrollTo-min.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/plugins/michael-multiselect-d918211/js/ui.multiselect.js"></script>
<!-- Jquery ui multiselect -->
<!-- TinyMCE textarea editor plugin -->
<script type="text/javascript" src="<?=base_url()?>assets/plugins/tinymce/tinymce.min.js"></script>
<!-- TinyMCE textarea editor plugin -->
<script src="<?=base_url()?>assets/plugins/jquery.blockUI.js"></script>
<script src="<?=base_url()?>assets/js/jspdf.js"></script>
<script src="<?=base_url()?>assets/js/libs/base64.js"></script>
<script src="<?=base_url()?>assets/js/libs/sprintf.js"></script>
<script src="<?=base_url()?>assets/js/print.js"></script>
<script src="<?=base_url()?>assets/js/script.js"></script>
<!-- Custom Scroll bar files  -->
<link href="<?=base_url()?>assets/plugins/mcustomscrollbar/jquery.mCustomScrollbar.css" rel="stylesheet" />
<script src="<?=base_url()?>assets/plugins/mcustomscrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
<!-- Custom Scroll bar files  -->
<!-- J Scroll bar files  -->
<link rel="stylesheet" href="<?=base_url()?>assets/plugins/jScrollbar-master/jquery/jScrollbar.jquery.css" type="text/css" />
<script type="text/javascript" src="<?=base_url()?>assets/plugins/jScrollbar-master/jquery/jquery-mousewheel.js"></script>
<script type="text/javascript" src="<?=base_url()?>assets/plugins/jScrollbar-master/jquery/jScrollbar.jquery.min.js"></script>
<!-- J Scroll bar files  -->
<?php
