...
<html lang="en">
	...
	<body class="login">
		...
		<div class="content">
			<!-- BEGIN LOGIN FORM -->
			<form class="login-form" action="<?=base_url()?>index/authenticate_user" method="post">
				...
				<div class="form-group">
					...
					<div class="input-icon">
						...
						<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="agentname"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-icon">
						...
						<input class="form-control placeholder-no-fix enter_login" type="password" autocomplete="off" placeholder="Password" name="agentpassword"/>
					</div>
				</div>
			...
			<script>
			$('.enter_login').on('keyup', function(event) {
			if (event.keyCode == 13)
			if (!event.shiftKey) $('.login-form').submit();
			});
			</script>
			<!-- END LOGIN FORM -->
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">
		2019 &copy; Powered by dans ATMS.
	</div>
	<!-- END COPYRIGHT -->
	=
