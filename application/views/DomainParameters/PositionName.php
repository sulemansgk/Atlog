	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Position Name
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				...
				<form action="<?=base_url()?>domainparameters/InsertPositionName" class="log-add-form" method="post">
						...
						<div class="form-actions left">
							...
							<div class="col-md-5">
								...
								<div class=" form-actions" style="border-top: 0">
									...
									<a href="<?=base_url()?>domainparameters/viewPositionNames" class="btn btn-primary">View Position Names</a>
