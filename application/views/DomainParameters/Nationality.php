	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Nationality
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				...
				<form action="<?=base_url()?>domainparameters/InsertNationality" class="log-add-form" method="post">
					...
					<div class="row pform" style="padding-top:1%;"  >
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="nationality" class="form-control" value="" placeholder="Enter value..." required="required"  />
					...
					<div class="form-actions left">
						...
						<div class="col-md-6">
							...
							<div class=" form-actions" style="border-top: 0">
								...
								<a href="<?=base_url()?>domainparameters/viewNationalities" class="btn btn-primary">View Nationalities</a>
