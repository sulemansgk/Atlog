<div class="row-fluid page-head">
	...
	<h2 class="page-title"><i class="fontello-icon-monitor"></i>User Rights</h2>
	<div class="page-bar">
...
<div class="viewlist-link">
	<a href="<?=base_url()?>domainparameters/viewUserRights" class="btn btn-blue">View User Rights</a>
</div>
		...
		<section>
			...
			<div class="form-row">
				...
				<span class="form-field">
					<input type="text" name="name" value="" placeholder="Enter value..." />
				</span>
			</div>
			<div class="form-row">
