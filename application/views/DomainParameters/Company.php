	...
	<div class="col-md-12">
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-desktop"></i>Company
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				...
				<form action="<?=base_url()?>domainparameters/InsertCompany" class="log-add-form" method="post">
					
					<div class="row pform" style="padding-top:1%;"  >
						<div class="col-md-6">
							<div class="form-group">
								<span class="form-field-title">Company</span>
					...
					<div class="form-actions left">
						...
						<div class="col-md-6">
							...
							<div class=" form-actions" style="border-top: 0">
								...
								<a href="<?=base_url()?>domainparameters/viewCompanies" class="btn btn-primary">View Companies</a>
