<div class="row-fluid page-head">
	...
	<h2 class="page-title"><i class="aweso-icon-list-alt"></i> Domain Parameter Calbration item</h2>
	<div class="page-bar">
		<div class="btn-toolbar"> </div>
	</div>
</div>
<div class="viewlist-link">
	<a href="<?=base_url()?>instructions/Viewparacalibrationitem" class="btn btn-blue">View Domain Parameter Calbration item</a>
</div>
<!-- // page head -->
<form action="<?=base_url()?>elog/insertcalibrationitem" class="log-add-form" method="post">
	<section>
